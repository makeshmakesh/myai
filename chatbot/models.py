...
class Profile(models.Model):
    ...
    openai_api_key = models.CharField(max_length=100, unique=False, blank=True, null=True)
    pinecone_api_key = models.CharField(max_length=100, unique=False, blank=True, null=True)
